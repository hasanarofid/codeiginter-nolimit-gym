            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="gap: 30px; margin-bottom: 15px;">
                        ...
                        <!-- QR Code Placeholder -->
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://wa.me/6287866860310" alt="QR Code" style="width: 100px; height: 100px; border: 2px solid #FFF; padding: 5px; border-radius: 10px; background: #FFF;">
                        
                        <a href="https://wa.me/6287866860310" target="_blank" style="color: #FFF; font-size: 3rem; transition: 0.3s;" onmouseover="this.style.color='#FF1414'" onmouseout="this.style.color='#FFF'"><i class="fa fa-whatsapp"></i></a>
                    </div>
                    <div>
                        <a href="https://wa.me/6287866860310" target="_blank" style="color: #FFF; font-weight: bold; font-size: 1.2rem; text-decoration: none; transition: 0.3s;" onmouseover="this.style.color='#FF1414'" onmouseout="this.style.color='#FFF'">
