            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $report['daily_earning'] ?></div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-primary text-white">
                <h5 class="m-0 font-weight-bold">Transaksi Terbaru (Hari Ini)</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            <?php if (empty($report['today_transactions'])): ?>
                                <tr>
                                    <td colspan="7" class="text-center text-muted">Belum ada transaksi hari ini</td>
                                </tr>
                            <?php else: ?>
                                <?php $i = 1; foreach ($report['today_transactions'] as $trx): ?>
                                    <tr>
                                        <td><?= $i++ ?></td>
