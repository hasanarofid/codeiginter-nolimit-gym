...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <?= anchor(base_url('nonmembership'), 'Back', ['title' => 'kembali', 'class' => "d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm float-right"]) ?>
    </div>
    <div class="card-body">
        <form name="nonmember_paket" action="<?= $action ?>" method="post">
            <?= csrf_field() ?>
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" value="Gym Non Membership" readonly>
                    <!-- catid di-set hidden agar tidak bisa diubah -->
                    <input type="hidden" name="catid" value="<?= $nm_cat_id ?>">
                </div>
                <div class="form-group col-md-3">
            ...
            <div class="form-row">
                ...
                <div class="form-group col">
                    <label for="expired">Jangka Waktu (bulan, isi 0 jika Per Visit) <span class="text-danger">*</span></label>
                    <input type="number" class="form-control <?= session('errors.expired') ? 'is-invalid' : '' ?>" id="expired" name="expired" value="<?= $expired ?? 0 ?>" min="0">
                    <small class="text-muted">Isi <b>0</b> untuk paket Per Visit (tidak ada jangka waktu)</small>
                    <div class="invalid-feedback">
