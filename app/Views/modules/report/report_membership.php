        ...
        <form id="reportForm" method="GET" class="mb-5">
            <div class="form-row">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" id="start_date" class="form-control datepicker" placeholder="____-__-__" readonly="true">
                </div>
                <div class="col-md-3">
                    <label for="end_date">Tanggal Akhir <span class="text-danger">*</span></label>
                    <input type="text" id="end_date" class="form-control datepicker" placeholder="____-__-__" readonly="true">
                </div>
                <div class="col-md-3">
                    <label>&nbsp;</label>
